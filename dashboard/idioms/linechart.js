...
const LineChartModule = (function() {
    ...
    function createLineChart(originalData, containerSelector) {
        ...
        // Get which activities should be highlighted
    ...
    function getHighlightedActivities() {
        // Get highlighted activities based on behavior filters
        if (typeof FilterModule !== 'undefined') {
            ...
            if (currentFilters.behaviors.length > 0) {
                ...
                const highlightedActivities = currentFilters.behaviors.map(filterKey => {
        ...
        // Return all activities if no behavior filters are active
